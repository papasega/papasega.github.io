...
2. [Qu'est ce que le data science ?](#2-qu'est-ce-que-le-data-science-?)
3. [Qu'est ce que le machine learning ?](#3-Qu'est-ce-que-le-machine-learning-?)
4. [Types de problèmes en Machine Learning (ML)](#4-ypes-de-problèmes-en-Machine-learning-(ML))
5. [Modèle linéaire en dimension 1: Regression linèaire](#5-Modèle-linéaire-en-dimension-1:-Regression-linèaire)
6. [Motivation statistique](#6-Motivation-statistique)
7. [Estimation des paramètres](#7-Estimation-des-paramètres)
8. [Évaluez l'exactitude de l'estimation à l'aide de R2](#8-Évaluez-l'exactitude-de-l'estimation-à-l'aide-de-R2)
...
Donc il serait intéressant un tour rapide du domaine de la science des données, et en quoi elle est devenue une source de valeur ajoutée pour
les entreprises.
