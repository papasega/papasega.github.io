...
Ainsi nous devons trouver le <img src="https://latex.codecogs.com/svg.latex?\Large&space;\hat{\beta_{0,1}}" title=" \hat{\beta_{0,1}}" /> optimal. Pour la régression linéaire en dimension 1, la \href{https://eli.thegreenplace.net/2014/derivation-of-the-normal-equation-for-linear-regression}{solution1} ou \href{https://en.wikipedia.org/wiki/Ordinary_least_squares}{solution2} de l'équation de minimisation (juste au-dessus) est exacte : 
...
{\color{blue} \large \textbf{ Loyer  = 30.6612*surface + 266.4546  }}
