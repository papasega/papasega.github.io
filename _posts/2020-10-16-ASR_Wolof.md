...
![image](https://drive.google.com/uc?export=view&id=1K2udnFV7ZX6v91v5gWY-Yzo2HVckjLxa)
     ...
     **Remarque**: Un N-gramme n'est rien d'autre que la probabilité du mot qui suive
     Exemple: Sama neexalu lijaasa bi kuma ko **jox** 
     P(jox | Sama, neexalu, lijaasa, bi, kuma, ko)
     Uni-gramme : P(jox)
     Bi-gramme : P(jox | ko)
     Tri-gramme : P(jox | kuma ko)
     etc. 
