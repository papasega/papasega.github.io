...
<img src="https://latex.codecogs.com/svg.latex?\Large&space; p(sama|\alpha) = \frac{c(sama  \alpha) }{\sum_{w}c(sama  \alpha)} " title="  " />
...
![image](https://drive.google.com/uc?export=view&id=1K2udnFV7ZX6v91v5gWY-Yzo2HVckjLxa)
     ...
     **Remarque2** Le calcul des probabilités s'effectue en utilisant la formule des probabilités conditionnelles.
      ...
      - P(Sama, neexalu, lijassa, bi, kumako, jox) =
       P(Sama)xP(neexalu|sama)xP(lijassa|sama neexalu)xP(bi|sama neexalu lijassa)xP(kumako|sama neexalu lijassa bi)x
         P(jox|sama neexalu lijassa bi kumako)
