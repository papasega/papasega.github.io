...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;  p( sunu  bataxalu  lijaasa  bi)  = p(sunu| •)  p(bataxalu  | sunu)  p(lijaasa | bataxalu  )  p(bi | lijaasa)  p(• | bi )  = \frac{c(•  sunu)}{\sum_w  c(• w)} \times \frac{c(sunu  bataxalu  )}{\sum_w  c(sunu  w)} \times  \frac{c(bataxalu  lijaasa)}{\sum_w  c(bataxalu    w)} \times  \frac{c(lijaasa  bi)}{\sum_w  c(lijassa  w)} \times  \frac{c(bi  • )}{\sum_w  c(bi  w)}  =            \frac{0}{3}            \times              \frac{0}{1}                         \times                      \frac{0}{1}                         \times                      \frac{2}{2}                       \times           \frac{1}{2}         = 0 " title="  " />
